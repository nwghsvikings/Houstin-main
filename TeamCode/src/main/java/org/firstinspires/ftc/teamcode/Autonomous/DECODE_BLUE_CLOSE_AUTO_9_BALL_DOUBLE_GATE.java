...
@Config
@Autonomous(name = "DECODE_BLUE_9_BALL_DOUBLE_GATE_PARK_CLOSE", group = "Robot")
public class DECODE_BLUE_CLOSE_AUTO_9_BALL_DOUBLE_GATE extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d initialPose = new Pose2d(-60.4, 37.9*R, Math.toRadians(FieldAngle(90))); //STARTING SPOT
...
*/
        ...
        TrajectoryActionBuilder Gate6 = Intake6.endTrajectory().fresh()
                ...
                .strafeToLinearHeading(new Vector2d(0,51*R), Math.toRadians(FieldAngle(90)))
                .waitSeconds(2);
        ...
        TrajectoryActionBuilder Intake9 = Shoot6.endTrajectory().fresh()
                .stopAndAdd(new AutoActions.IntakeAction(intake,.8)) //INTAKE POWER ON
                .strafeToLinearHeading(new Vector2d(11.7,23.5*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(60), new ProfileAccelConstraint(-60, 60))
                .strafeToLinearHeading(new Vector2d(11.7,60.4*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(60), new ProfileAccelConstraint(-60, 60));

        TrajectoryActionBuilder Gate9 = Intake9.endTrajectory().fresh()
                .stopAndAdd(new AutoActions.IntakeAction(intake,.3)) //INTAKE POWER ON
                .strafeToLinearHeading(new Vector2d(11.7,45*R), Math.toRadians(FieldAngle(90)))
                .strafeToLinearHeading(new Vector2d(0,51*R), Math.toRadians(FieldAngle(90)))
                .waitSeconds(2);
        ...
        Action TurretCameraAction = new AutoActions.TurretCameraAction(camera,turret, telemetry,500,0);
