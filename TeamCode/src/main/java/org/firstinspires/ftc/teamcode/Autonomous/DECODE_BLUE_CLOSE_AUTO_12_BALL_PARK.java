...
@Config
@Autonomous(name = "DECODE_BLUE_12_BALL_PARK_CLOSE", group = "Robot")
public class DECODE_BLUE_CLOSE_AUTO_12_BALL_PARK extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder Intake9 = Shoot6.endTrajectory().fresh()
                .stopAndAdd(new AutoActions.IntakeAction(intake,.8)) //INTAKE POWER ON
                .strafeToLinearHeading(new Vector2d(11.7,23.5*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(90), new ProfileAccelConstraint(-90, 90))
                .strafeToLinearHeading(new Vector2d(11.7,58*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(80), new ProfileAccelConstraint(-80, 80));
        ...
        TrajectoryActionBuilder Intake12 = Shoot9.endTrajectory().fresh()
                .stopAndAdd(new AutoActions.IntakeAction(intake,.8)) //INTAKE POWER ON
                .strafeToLinearHeading(new Vector2d(32,27*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(70), new ProfileAccelConstraint(-70, 70))
                .strafeToLinearHeading(new Vector2d(32,58*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(70), new ProfileAccelConstraint(-70, 70));
        ...
        TrajectoryActionBuilder MoveToShoot12 = Intake12.endTrajectory().fresh()
                ...
                .setTangent(Math.toRadians(FieldAngle(270)))
                .splineToLinearHeading(new Pose2d(-11.7, 23.5*R, Math.toRadians(FieldAngle(90))), Math.toRadians(180));
               // .strafeToLinearHeading(new Vector2d(-15,20*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(80), new ProfileAccelConstraint(-60, 60));
