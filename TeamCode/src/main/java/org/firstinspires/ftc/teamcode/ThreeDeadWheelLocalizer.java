...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1151.08141193963; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 895.2209699499211; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1444.048597528365; // x position of the perpendicular encoder (in tick units)
    }
