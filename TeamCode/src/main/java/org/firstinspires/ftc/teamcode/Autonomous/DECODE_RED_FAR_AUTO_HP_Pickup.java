...
@Config
@Autonomous(name = "DECODE_RED_HP_Pickup_PARK_FAR", group = "Robot")
public class DECODE_RED_FAR_AUTO_HP_Pickup extends LinearOpMode {
...
//*/
        ...
        TrajectoryActionBuilder Shoot3 = TurretStartingPosition.endTrajectory().fresh()
                .stopAndAdd(new AutoActions.Shoot3Balls(intake,1,flywheel,1825,transfer, telemetry)); //SHOOT 3 BALLS
        ...
        TrajectoryActionBuilder Intake6 = Shoot3.endTrajectory().fresh()
                ...
                .strafeToLinearHeading(new Vector2d(49,60*R), Math.toRadians(FieldAngle(70)), new TranslationalVelConstraint(80), new ProfileAccelConstraint(-80, 80))
                .waitSeconds(.7)
                .strafeToLinearHeading(new Vector2d(54 ,57*R), Math.toRadians(FieldAngle(70)), new TranslationalVelConstraint(80), new ProfileAccelConstraint(-80, 80))
                .strafeToLinearHeading(new Vector2d(63 ,62*R), Math.toRadians(FieldAngle(70)), new TranslationalVelConstraint(40), new ProfileAccelConstraint(-40, 80))
                .waitSeconds(.4)
                ...
                //.setTangent(Math.toRadians(FieldAngle(90)))
                //.splineToLinearHeading(new Pose2d(57, 53*R, Math.toRadians(FieldAngle(110))), Math.toRadians(270))
                //.setTangent(Math.toRadians(FieldAngle(0)))
              //  .splineToLinearHeading(new Pose2d(63, 64*R, Math.toRadians(FieldAngle(90))), Math.toRadians(90))
        ...
        TrajectoryActionBuilder Intake9 = Shoot6.endTrajectory().fresh()
                .stopAndAdd(new AutoActions.IntakeAction(intake,.5)) //INTAKE POWER ON
                .strafeToLinearHeading(new Vector2d(55,60.4*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(90), new ProfileAccelConstraint(-60, 90))
                .strafeToLinearHeading(new Vector2d(55,45*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(90), new ProfileAccelConstraint(-90, 90))
                .strafeToLinearHeading(new Vector2d(55,60.4*R), Math.toRadians(FieldAngle(80)), new TranslationalVelConstraint(90), new ProfileAccelConstraint(-90, 90))
                .strafeToLinearHeading(new Vector2d(55,50*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(90), new ProfileAccelConstraint(-90, 90))
                .strafeToLinearHeading(new Vector2d(55,60.4*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(90), new ProfileAccelConstraint(-90, 90))
                .strafeToLinearHeading(new Vector2d(60,25*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(60), new ProfileAccelConstraint(-60, 60));
