...
@Config
@Autonomous(name = "DECODE_BLUE_9_BALL_PARK_FAR", group = "Robot")
public class DECODE_BLUE_FAR_AUTO_9_BALL_PARK extends LinearOpMode {
...
//*/
        ...
        TrajectoryActionBuilder Intake9 = Shoot6.endTrajectory().fresh()
                ...
                .strafeToLinearHeading(new Vector2d(11.7,58.4*R), Math.toRadians(FieldAngle(90)), new TranslationalVelConstraint(80), new ProfileAccelConstraint(-80, 80));
        ...
        TrajectoryActionBuilder Intake12 = TurretEndingPosition.endTrajectory().fresh()
                .stopAndAdd(new AutoActions.IntakeAction(intake,.8)) //INTAKE POWER ON
